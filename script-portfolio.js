const portfolioData = {
  fr: {
    ...
    aboutText: "Spécialiste du reporting et de la performance, j’ai accompagné plus de 20 marques internationales pour transformer leurs données en leviers d'action immédiats.<br><b>Ma règle d'or :</b> Je ne produis pas de l'esthétique pour \"embellir\" des diapositives. Je bâtis des outils pour transformer la donnée en décision.<br><br>Mon architecture repose sur trois organes spécialisés :<br><ul class=\"indented-list\"><li><strong>L’Analyse Fine :</strong> Interpréter les signaux faibles, pas seulement afficher des chiffres.</li><li><strong>L’Optimisation :</strong> Fluidifier les processus métiers pour que la structure serve l'action.</li><li><strong>Le Pilotage Humain :</strong> Parce qu’une donnée n’a de valeur que par l'intelligence de ceux qui l'activent.</li></ul><br>Mon objectif : Que chaque dashboard soit un moteur stratégique, chaque limite une opportunité de dépassement, et chaque engagement une performance exécutée avec précision.",
    
    passionTitle: "MON MOTEUR DE RÉFLEXION",
    passionDescription: "Mon égosystème ne s’arrête pas au bureau. Il se nourrit d’influences qui transforment ma vision stratégique.<br><ul class=\"indented-list\"><li>🎮 <b>Gaming & Stratégie :</b> L'art de la pensée en arborescence. Modéliser des scénarios, anticiper les risques et improviser.</li><li>💻 <b>Code & Logique :</b> Mon laboratoire personnel. Maîtriser la structure invisible derrière chaque interface.</li><li>🎌 <b>Culture Japonaise :</b> Rigueur, esthétique épurée et philosophie du Kaizen (amélioration continue).</li><li>🎧 <b>Musique & Rythme :</b> Le métronome de ma productivité. Elle cadence mes cycles.</li><li>♟️ <b>Échecs :</b> Le terrain de la réflexion pure. Anticiper plusieurs coups, élaborer des stratégies et transformer chaque partie en apprentissage tactique.</li></ul>Loin d'être de simples loisirs, elles constituent mon infrastructure d'apprentissage continu.",
